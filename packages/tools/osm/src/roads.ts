...
const roadsParameters = z.object({
  mapBounds: z
    .object({
      northwest: z
        .object({
...
export type RoadsFunctionArgs = z.infer<typeof roadsParameters>;
 ...
 * ```
 */
export const roads: OpenAssistantTool<
  typeof roadsParameters,
  RoadsLlmResult,
  RoadsAdditionalData,
  OsmToolContext
> = {
